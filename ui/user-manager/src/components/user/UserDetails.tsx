...
export default function UserDetails({ member }:UserDetailsProps) {
  ...
  return (
    <>
      ...
      <TitleAndSubtitle title="Birthday" subtitle={tzAgnosticDate(member.dateOfBirth)} formatDate />
      ...
      <TitleAndSubtitle title="Date of Baptism" subtitle={tzAgnosticDate(member.dateOfBaptism)} formatDate />
      <TitleAndSubtitle title="Date of Confirmation" subtitle={tzAgnosticDate(member.dateOfConfirmation)} formatDate />
      <TitleAndSubtitle title="Status in Canada" subtitle={member.canadianStatus} source={UserDataCanadianStatusEnum} />
      <TitleAndSubtitle title="In Canada Since" subtitle={tzAgnosticDate(member.inCanadaSince)} formatDate />
