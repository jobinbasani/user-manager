...
// GetAdminCandidates - List of users who can be added to admin group
func (s *AdminApiService) GetAdminCandidates(ctx context.Context, search string) (ImplResponse, error) {
	// TODO - update GetAdminCandidates with the required logic for this service method.
	// Add api_admin_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetAdminCandidates method not implemented")
}
